...
const SEDES = {
  ...
  concepcion: {
    ...
    estudios: [
      ...
      },
      {
        ...
        estado: "RECLUTAMIENTO ACTIVO",
        descripcionProfesional:
          "<p class=\"card-text w-100\">Estudio aleatorizado, doble ciego, de fase 3, de monoterapia con Pumitamig comparada con pembrolizumab como tratamiento de primera línea en participantes con cáncer de pulmón de celulas no pequeñas localmente avanzado o metastásico con PD-L1 &ge; 50%</p>\n<p>\n<ul>\n<li><strong>Patología:</strong> Pulmón</li>\n<li><strong>Fase:</strong> 3</li>\n<li><strong>Ramas de tratamiento:</strong>\n<ul>\n<li><strong>A:</strong> Pumitamig 1200 ms Q3W &lt;50 kg o 1500 mg Q3W &gt;50 kg i.v.</li>\n<li><strong>B:</strong> Pembrolizumab 200 mg Q3W i.v.</li>\n<li><strong>Nombre del investigador principal</strong> Dr. José Barbosa Hernández</li>\n<li><strong>Código clinicaltrials.gov:</strong> NCT07361510</li>\n</ul>\n</li>\n</ul>\n</p>",
        descripcionPaciente:
      ...
      },
      {
        ...
        img: "./img/cover/cover5.jpg",
        videoLink: "#",
        infoLink: "https://www.clinicaltrials.gov/ct2/results?cond=NSCLC%2C+Stage+III&term=&cntry=CL&state=&city=concepcion&dist=",
      },
      {
        titulo: "MK7684A-007",
        estado: "RECLUTAMIENTO CERRADO",
        ...
        img: "./img/cover/cover1.jpg",
        videoLink: "#",
        infoLink: "https://www.clinicaltrials.gov/ct2/results?cond=Lung+Cancer+Metastatic&term=&cntry=CL&state=&city=Concepci%C3%B3n&dist=",
      },
      {
        // Nuevo: no estaba publicado en la web.
        titulo: "BFAST",
        estado: "RECLUTAMIENTO CERRADO",
        descripcionProfesional:
          "<p class=\"card-text w-100\">Estudio fase II/III multicéntrico para evaluar la eficacia y seguridad de múltiples terapias dirigidas, como tratamiento para pacientes con cáncer de pulmón de células no pequeñas (CPCNP) avanzado o metastásico portadores de mutaciones somáticas tratables detectadas en sangre (BFAST: blood-first assay screening trial [estudio de selección con valoración inicial en sangre])</p>\n<p>\n<ul>\n<li><strong>Patología:</strong> Pulmón</li>\n<li><strong>Fase:</strong> II/III</li>\n<li><strong>Ramas de tratamiento:</strong>\n<ul>\n<li>GDC-6036</li>\n<li>DOCETAXEL</li>\n<li><strong>Nombre del investigador principal</strong> Dra. Esther Rodríguez De Vásquez</li>\n<li><strong>Código clinicaltrials.gov:</strong> NCT03178552</li>\n</ul>\n</li>\n</ul>\n</p>",
        descripcionPaciente:
        ...
        img: "./img/cover/cover5.jpg",
        videoLink: "#",
        infoLink: "https://clinicaltrials.gov/ct2/show/NCT03178552?term=GDC-6036&cond=%22Carcinoma%2C+Non-Small-Cell+Lung%22&draw=2&rank=2",
      },
      {
        titulo: "MK2870-011",
        estado: "RECLUTAMIENTO ACTIVO",
        descripcionProfesional:
          "<p class=\"card-text w-100\">Estudio fase 3, compara eficacia y seguridad de sacituzumab tirumotecán (sac-TMT, MK-2870) como monoterapia y en combinación con pembrolizumab (MK-3475) frente al tratamiento elegido por el médico en participantes con cáncer de mama triple negativo, sin tratamiento previo, localmente recurrente, metastásico o irresecable, con CPS de PD-L1 menor a 10.</p>\n<p>\n<ul>\n<li><strong>Patología:</strong> Mama</li>\n<li><strong>Fase:</strong> 3</li>\n<li><strong>Ramas de tratamiento:</strong>\n<ul>\n<li><strong>A:</strong> sac-TMT (4mg/kg c/2 semanas)</li>\n<li><strong>B:</strong> sac-TMT (4mg/kg c/2 semanas) + pembrolizumab (400 mg c/6 semanas por 18 ciclos)</li>\n<li><strong>C:</strong> Platino de elección</li>\n<li><strong>Nombre del investigador principal</strong> Dr. Geraldo Pereira Roca</li>\n<li><strong>Código clinicaltrials.gov:</strong> NCT06841354</li>\n</ul>\n</li>\n</ul>\n</p>",
        descripcionPaciente:
          "<p class=\"card-text w-100\">Estudio fase 3, para pacientes con cáncer de mama triple negativo, sin tratamiento previo, localmente recurrente, metastásico o irresecable, con PD-L1 menor a 10. El paciente recibirá sacituzumab tirumotecán (sac-TMT, MK-2870) como monoterapia y en combinación con pembrolizumab (MK-3475) frente al tratamiento elegido por el médico.</p>",
        etiquetas: ["todos", "Oncología"],
        img: "./img/cover/cover5.jpg",
        videoLink: "#",
        infoLink: "https://clinicaltrials.gov/search?term=2870%20011",
      },
      {
        titulo: "CAMBRIA 2",
        estado: "RECLUTAMIENTO CERRADO",
        descripcionProfesional:
          "<p class=\"card-text w-100\">Estudio de fase III, abierto, aleatorizado, para evaluar la eficacia y la seguridad de camizestrant (AZD9833) en comparación con la terapia endocrina estándar (inhibidor de la aromatasa o tamoxifeno) como tratamiento adyuvante en pacientes con cáncer de mama temprano ER+/HER2- y un riesgo intermedio-alto o alto de recurrencia que han completado el tratamiento locorregional definitivo y no tienen evidencia de enfermedad.</p>\n<p>\n<ul>\n<li><strong>Patología:</strong> Mama</li>\n<li><strong>Fase:</strong> 3</li>\n<li><strong>Ramas de tratamiento:</strong>\n<ul>\n<li><strong>A:</strong> Terapia endocrina (AI o Tamoxifeno) + agonista LHRH</li>\n<li><strong>B:</strong> Camizestrant 75 mg + agonista LHRH</li>\n<li><strong>Nombre del investigador principal</strong> Dra. Esther Rodríguez De Vásquez</li>\n<li><strong>Código clinicaltrials.gov:</strong> NCT05952557</li>\n</ul>\n</li>\n</ul>\n</p>",
        descripcionPaciente:
          "<p class=\"card-text w-100\">Estudio de fase 3, para pacientes con cáncer de mama temprano ER+/HER2- y un riesgo intermedio-alto o alto de recurrencia que han completado el tratamiento locorregional definitivo y no tienen evidencia de enfermedad. Los pacientes recibirán camizestrant (AZD9833) o terapia endocrina estándar (inhibidor de la aromatasa o tamoxifeno) como tratamiento adyuvante.</p>",
        etiquetas: ["todos", "Oncología"],
        img: "./img/cover/cover6.jpg",
        videoLink: "#",
        infoLink: "https://clinicaltrials.gov/search?term=D8535C00001",
      },
      {
        titulo: "CAMBRIA 1",
        estado: "RECLUTAMIENTO CERRADO",
        descripcionProfesional:
          "<p class=\"card-text w-100\">Estudio de fase III, abierto, aleatorizado, para evaluar la eficacia y la seguridad de la terapia extendida con camizestrant (AZD9833, un degradador selectivo del receptor de estrógeno oral de nueva generación) en comparación con la terapia endocrina estándar (inhibidor de la aromatasa o tamoxifeno) en pacientes con cáncer de mama temprano ER+/HER2- y un riesgo intermedio o alto de recurrencia que han completado la terapia locorregional definitiva y al menos 2 años de terapia endocrina adyuvante estándar sin recurrencia de la enfermedad.</p>\n<p>\n<ul>\n<li><strong>Patología:</strong> Mama</li>\n<li><strong>Fase:</strong> III</li>\n<li><strong>Ramas de tratamiento:</strong>\n<ul>\n<li><strong>A:</strong> Continuarán con la TE estándar de elección del investigador (inhibidores de la aromatasa [AI; exemestano, letrozol, anastrozol], con o sin agonistas de la hormona liberadora de la hormona luteinizante [LHRH], o tamoxifeno, dosis estándar según el investigador, una vez al día).</li>\n<li><strong>B:</strong> Camizestrant (150 mg, una vez al día) con o sin agonistas de la LHRH</li>\n<li><strong>Nombre del investigador principal</strong> Dra. Esther Rodríguez De Vásquez</li>\n<li><strong>Código clinicaltrials.gov:</strong> NCT05774951</li>\n</ul>\n</li>\n</ul>\n</p>",
        descripcionPaciente:
        ...
        videoLink: "#",
        infoLink: "https://clinicaltrials.gov/study/NCT05774951?cond=Breast%20Cancer&intr=Camizestrant&lat=-36.8295992&lng=-73.0524092&locStr=Current%20Location&distance=183&term=D8531C00002&rank=1",
      },
      {
        titulo: "SERENA 4",
        estado: "RECLUTAMIENTO CERRADO",
        descripcionProfesional:
          "<p class=\"card-text w-100\">Estudio aleatorizado, multicéntrico, doble ciego, fase III de AZD9833 (un SERD oral) más palbociclib comparado con anastrozol más palbociclib para el tratamiento de pacientes con cáncer de mama avanzado receptor estrógenos positivo, HER2-negativo que no han recibido ningún tratamiento sistémico para enfermedad avanzada (SERENA-4)</p>\n<p>\n<ul>\n<li><strong>Patología:</strong> Mama</li>\n<li><strong>Fase:</strong> III</li>\n<li><strong>Ramas de tratamiento:</strong>\n<ul>\n<li><strong>A:</strong> AZD9833 + Palbociclib + Placebo Anastrazol</li>\n<li><strong>B:</strong> Placebo AZD9833 + Palbociclib + Anastrazol</li>\n<li><strong>Nombre del investigador principal</strong> Dra. Esther Rodríguez De Vásquez</li>\n<li><strong>Código clinicaltrials.gov:</strong> NCT04711252</li>\n</ul>\n</li>\n</ul>\n</p>",
        descripcionPaciente:
      ...
      },
      {
        ...
        infoLink: "https://clinicaltrials.gov/study/NCT06120491?cond=Prostate%20Cancer&term=evopar&aggFilters=status:rec&rank=1",
      },
      ...
      },
      {
        ...
        infoLink: "https://www.clinicaltrials.gov/study/NCT05624554?cond=Leukemia%20Lymphocytic%20Chronic%20B-Cell&intr=Nemtabrutinib&rank=1",
      },
      {
        titulo: "MK1026-010",
        estado: "RECLUTAMIENTO ABIERTO",
        ...
        infoLink: "https://clinicaltrials.gov/study/NCT05947851?intr=Nemtabrutinib&checkSpell=&locStr=Concepci%C3%B3n,%20Chile&country=Chile&state=Bio%20Bio&city=Concepci%C3%B3n&rank=1",
      },
      {
        titulo: "PTG-300",
        estado: "RECLUTAMIENTO CERRADO",
        descripcionProfesional:
          "<p class=\"card-text w-100\">Un estudio de Fase 3 del mimético de hepcidina, Rusfertida (PTG-300), en pacientes con policitemia vera.</p>\n<p>\n<ul>\n<li><strong>Patología:</strong> Policitemia Vera</li>\n<li><strong>Fase:</strong> III</li>\n<li><strong>Ramas de tratamiento:</strong>\n<ul>\n<li>RUSFERTIDA/PLACEBO</li>\n<li><strong>Nombre del investigador principal</strong> Dr. Mauricio Chandía Cabas</li>\n<li><strong>Código clinicaltrials.gov:</strong> NCT05210790</li>\n</ul>\n</li>\n</ul>\n</p>",
        descripcionPaciente:
        ...
        infoLink: "https://www.clinicaltrials.gov/study/NCT05210790?cond=Polycythemia%20Vera&term=PTG-300-11&rank=1",
      },
      ...
      /* ----- SIN RESPALDO EN LOS DOCUMENTOS DE JULIO 2026 -----
         Estos estudios están publicados desde antes pero NO aparecen en los
         Word entregados por el cliente. Se conservan tal cual (todos están
         CERRADOS) a la espera de que confirme si deben retirarse o si los
         documentos solo cubren los estudios vigentes. No se han actualizado
         sus datos porque no hay fuente contra la que contrastarlos. */
      {
        titulo: "MK2140-003",
        estado: "RECLUTAMIENTO CERRADO",
        descripcionProfesional:
        ...
        img: "./img/cover/cover1.jpg",
        videoLink: "#",
        infoLink: "https://clinicaltrials.gov/study/NCT05139017?term=zilovertamab&page=2&rank=12",
      },
      {
        titulo: "MK2140-010",
        estado: "RECLUTAMIENTO CERRADO",
        ...
        img: "./img/cover/cover2.jpg",
        videoLink: "#",
        infoLink: "https://clinicaltrials.gov/study/NCT06717347?term=zilovertamab&rank=10",
      },
      {
        titulo: "MK3475A-F65",
        estado: "RECLUTAMIENTO CERRADO",
        ...
        img: "./img/cover/cover3.jpg",
        videoLink: "#",
        infoLink: "https://clinicaltrials.gov/study/NCT06504394?term=MK3475A-F65&rank=1",
      },
      {
        titulo: "DS7300-203",
        estado: "RECLUTAMIENTO CERRADO",
  ...
  chillan: {
    ...
    contacto: {
      ...
      // de Google Maps del centro cuando exista, para que marque el punto
